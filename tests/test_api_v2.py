...
r = requests.post('http://127.0.0.1:5000/api/v2/login', json={'username':'user','password':'pass'})
...
r2 = requests.post('http://127.0.0.1:5000/api/v2/simulation/start', json={'numAgents':3,'numScenarios':5}, headers=headers)
