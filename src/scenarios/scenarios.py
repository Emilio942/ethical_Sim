...
class EthicalScenario:
    ...
    def get_moral_foundation_impact(self, option_name: str, foundation: str) -> float:
        ...
        if option_name in self.moral_implications and foundation in self.moral_implications[option_name]:
...
class ScenarioGenerator:
    ...
    def __init__(self):
        ...
        self.belief_categories = [
            "Gerechtigkeit", "Freiheit", "Sicherheit", "Wohlfahrt", 
            "Autonomie", "Würde", "Gleichheit", "Solidarität"
        ]
    ...
    def create_scenario_from_template(self, template_name: str, scenario_id: str = None) -> EthicalScenario:
    ...
    def create_custom_scenario(self, scenario_id: str, description: str, 
                             options: Dict[str, Dict[str, float]], **kwargs) -> EthicalScenario:
